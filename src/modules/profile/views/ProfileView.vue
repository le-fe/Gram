	...
	<div class="container pro-container m-auto">
		...
		<div class="flex lg:flex-row flex-col items-center lg:py-8 lg:space-x-8">
			...
			<div class="lg:w/8/12 flex-1 flex flex-col lg:items-start items-center">
				...
				<div class="capitalize flex font-semibold space-x-3 text-center text-sm my-2">
					...
					<a href="#" class="bg-pink-500 shadow-sm p-2 pink-500 px-6 rounded-md text-white hover:text-white hover:bg-pink-600">
						Send message</a
					>
					<div>
						<a
		...
		<div class="my-6 grid lg:grid-cols-5 grid-cols-3 gap-2 hover:text-yellow-700 uk-link-reset">
			...
			<a href="#story-modal" uk-toggle="">
				<img
					src="http://demo.foxthemes.net/instellohtml/assets/images/avatars/avatar-lg-1.jpg"
					alt=""
		...
		<div class="my-6 grid lg:grid-cols-4 grid-cols-2 gap-1.5 hover:text-yellow-700 uk-link-reset">
			<div>
				<div class="bg-red-500 max-w-full lg:h-64 h-40 rounded-md relative overflow-hidden uk-transition-toggle" tabindex="0">
					...
					>
						...
						<a href="#story-modal" uk-toggle="" class="flex items-center">
							<ion-icon name="pricetags" class="mr-1 md hydrated" role="img" aria-label="pricetags"></ion-icon> 12
						</a>
					</div>
				</div>
			</div>
			<div>
				<div class="bg-red-500 max-w-full lg:h-64 h-40 rounded-md relative overflow-hidden uk-transition-toggle" tabindex="0">
					<img
						src="http://demo.foxthemes.net/instellohtml/assets/images/post/img1.jpg"
						class="w-full h-full absolute object-cover inset-0"
					/>
