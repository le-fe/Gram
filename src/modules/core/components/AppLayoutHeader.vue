		...
		<div class="header_inner">
			<div class="flex items-center">
				<div class="relative">
					...
					<div class="icon-search absolute right-2 top-2">
			...
			<div class="right-side lg:pr-4">
				...
				>
					<ion-icon
						name="add-circle"
						class="-mb-1 mr-1 opacity-90 text-xl uilus-circle md hydrated"
						role="img"
				...
				<div
					...
					class="header_dropdown uk-dropdown"
				>
					<!-- notivication header -->
				...
				<a href="#" class="header-links-item" aria-expanded="false">
				...
				<div uk-drop="mode: click;offset: 4" class="header_dropdown uk-drop">
